        ...
        <div class="flex gap-8 flex-col md:flex-row">
            <div class="w-full md:w-1/2 flex flex-col">
                <div class="mb-5">
                    ...
                    <x-form-input type="email" id="email" name="form.email" placeholder="Email..."
                        model="form.email" />
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <x-form-input type="password" id="password_confirmation" name="form.password"
                        placeholder="Confirm password..." model="form.password_confirmation" />
                </div>
                <div class="mb-5">
