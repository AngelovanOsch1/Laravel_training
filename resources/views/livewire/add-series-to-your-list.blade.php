<div>
    @if($show)
        <div class="fixed inset-0 flex justify-center items-center z-50 bg-gray-800/25">
            <div class="bg-gray-100 p-6 rounded-lg shadow-lg w-full max-w-[910px] min-h-[610px] flex flex-col">
                        ...
                        <div>
                            ...
                            @if(strlen($query) <= 2)
                                <div class="flex flex-col items-center justify-center h-64 text-gray-400 mt-20 select-none">
                                    ...
                                    <p class="text-lg font-semibold">Start typing to search series</p>
                                </div>
                ...
                <div class="mt-4 flex items-center justify-between pt-4 space-x-4">
                    ...
                    <div class="flex space-x-2">
                        <div class="w-2 h-2 rounded-full transition-all duration-300 {{ $stepCount === 0 ? 'bg-teal-600' : 'bg-gray-600' }}"></div>
                        <div class="w-2 h-2 rounded-full transition-all duration-300 {{ $stepCount === 1 ? 'bg-teal-600' : 'bg-gray-600' }}"></div>
                    </div>
                    <x-primary-button
